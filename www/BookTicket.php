...
<?php
	...
	echo "Congratulations!!!<br><br><br>";
	$db=mysqli_select_db($conn,"signup");
	$query="INSERT into ticket values('$_POST[firstname]','$_POST[email]','$_POST[phone]','$_POST[age]','$_POST[country]','$_POST[N]')";
	$result=mysqli_query($conn,$query);
	echo "You have Succesfully booked $_POST[N] Tickets to Watch a Live Match at Camp Nou.Enjoy your day.Visca El Barca!!";
	mysqli_close($conn);
?>
</p>
